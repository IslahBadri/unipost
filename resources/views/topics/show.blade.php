          ...
          <div class="panel panel-default change-panel">
            <div class="panel-heading">
              ...
              <div class="topic-panel">
                ...
                @endif
                <h4>&nbsp;&nbsp;{{ $topic->title }}</h4>
                <h5>&nbsp;&nbsp;&nbsp;<a href="{{ route('profile.show', Auth::id()) }}" style="color:#777;" >{{ ucwords($topic->user->name) }}</a></h5>
              </div>
            </div>
            <ul class="list-group">
          ...
          <div class="panel panel-default change-panel">
            <div class="panel-heading" style="padding-bottom:15px;">
              ...
              <div class="topic-panel">                
                ...
                @endif
                <h5>&nbsp;&nbsp;&nbsp;<a href="{{ route('profile.show', Auth::id()) }}" style="color:#777;" >{{ ucwords($comment->user->name) }}</a></h5>
